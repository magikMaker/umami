...
export const labels = defineMessages({
  ...
  postback: { id: 'label.postback', defaultMessage: 'Postback' },
  postbacks: { id: 'label.postbacks', defaultMessage: 'Postbacks' },
  addPostback: { id: 'label.add-postback', defaultMessage: 'Add postback' },
  endpoint: { id: 'label.endpoint', defaultMessage: 'Endpoint' },
  endpoints: { id: 'label.endpoints', defaultMessage: 'Endpoints' },
  endpointUrl: { id: 'label.endpoint-url', defaultMessage: 'Endpoint URL' },
  debugMode: { id: 'label.debug-mode', defaultMessage: 'Debug mode' },
  debug: { id: 'label.debug', defaultMessage: 'Debug' },
  debugModeDisabled: {
    id: 'label.debug-mode-disabled',
    defaultMessage: 'Debug mode is disabled',
  },
  ...
  autoRefreshOn: {
    id: 'label.auto-refresh-on',
    defaultMessage: 'Auto-refresh ON',
  },
  autoRefreshOff: {
    id: 'label.auto-refresh-off',
    defaultMessage: 'Auto-refresh OFF',
  },
  relays: { id: 'label.relays', defaultMessage: 'Relays' },
  requests: { id: 'label.requests', defaultMessage: 'Requests' },
  redirect: { id: 'label.redirect', defaultMessage: 'Redirect' },
  redirects: { id: 'label.redirects', defaultMessage: 'Redirects' },
  createRedirect: { id: 'label.create-redirect', defaultMessage: 'Create redirect' },
  editRedirect: { id: 'label.edit-redirect', defaultMessage: 'Edit redirect' },
  deleteRedirect: { id: 'label.delete-redirect', defaultMessage: 'Delete redirect' },
  noRedirects: { id: 'label.no-redirects', defaultMessage: 'No redirects' },
  clicks: { id: 'label.clicks', defaultMessage: 'Clicks' },
  noClicks: { id: 'label.no-clicks', defaultMessage: 'No clicks yet' },
  slug: { id: 'label.slug', defaultMessage: 'Slug' },
  active: { id: 'label.active', defaultMessage: 'Active' },
  inactive: { id: 'label.inactive', defaultMessage: 'Inactive' },
